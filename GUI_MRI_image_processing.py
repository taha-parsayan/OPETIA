...
entry1 = ctk.CTkEntry(master=frame1, textvariable = var_T1_path, width = 250, height=25)
entry1.place(x=120, y=40)

lable2 = ctk.CTkLabel(master=frame1, text="Set output image address:", font=("Times New Roman", 15))
...
entry2 = ctk.CTkEntry(master=frame1, textvariable=var_output_path, width = 250, height=25)
